...
class MutationObjectTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.align = AlignIO.read(pathlib.PurePath(pathlib.Path(__file__).parent.resolve(), 'Mutations/test.fasta'), 'fasta')
        self.mutations = AlignInfo.Mutations(self.align)

    #def test_find_sequence_index_by_id
