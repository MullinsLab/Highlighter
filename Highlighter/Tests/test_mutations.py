...
class MutationTests(unittest.TestCase):
    ...
    def test_get_mutations_error_if_bad_types(self):
        ...
        with self.assertRaises(TypeError):
            get_mutations(sequence=1, reference='ATGC')

        with self.assertRaises(TypeError):
            get_mutations(sequence='ATGC', reference=[])
    ...
    def test_get_mutations_returns_dict(self):
        ...
        self.assertEqual(type(get_mutations(sequence='ATGC', reference='ATGC')), dict)
    ...
    def test_get_mutations_returns_empty_dict_given_same_sequence_and_reference(self):
        ...
        self.assertEqual(get_mutations(sequence='ATGC', reference='ATGC'), {})
    ...
    def test_get_mutations_returns_non_empty_dict_given_different_sequence_and_reference(self):
        ...
        self.assertNotEqual(get_mutations(sequence='ATGC', reference='ATGG'), {})
    ...
    def test_get_mutations_returns_correct_dict_given_different_sequence_and_reference(self):
        ...
        self.assertEqual(get_mutations(reference='GTGCGGC-', sequence='AATGCA-T'), {0: ['A'], 1: ['A'], 2: ['T'], 3: ['G'], 4: ['C'], 5: ['A'], 6: ['Gap'], 7: ['T']})
        self.assertEqual(get_mutations(g_to_a=True, reference='GTGCGGC-', sequence='AATGCA-T'), {0: ['A', 'G->A mutation'], 1: ['A'], 2: ['T'], 3: ['G'], 4: ['C'], 5: ['A', 'G->A mutation'], 6: ['Gap'], 7: ['T']})
        self.assertEqual(get_mutations(apobec=True, reference='GTGCGGC-', sequence='AATGCA-T'), {0: ['A', 'APOBEC'], 1: ['A'], 2: ['T'], 3: ['G'], 4: ['C'], 5: ['A'], 6: ['Gap'], 7: ['T']})
        self.assertEqual(get_mutations(g_to_a=True, apobec=True, reference='GTGCGGC-', sequence='AATGCA-T'), {0: ['A', 'G->A mutation', 'APOBEC'], 1: ['A'], 2: ['T'], 3: ['G'], 4: ['C'], 5: ['A', 'G->A mutation'], 6: ['Gap'], 7: ['T']})
    ...
    def test_stuff_with_bio_align(self):
        ...
        self.assertEqual(align.get_mutations(), "test")
